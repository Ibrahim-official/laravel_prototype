...
<body class="h-full">
    ...
    <nav class="bg-gray-800">
        ...
        <div class="flex h-16 items-center justify-between">
            ...
            <div class="shrink-0">
                <img class="h-9 w-10" src="https://laracasts.com/images/logo/logo-triangle.svg" alt="Your Company">
            </div>
        ...
        <div class="border-t border-gray-700 pt-4 pb-3">
            ...
            <div class="ml-3">
                ...
                <div class="text-sm font-medium text-gray-400">lary@ai.robot.com</div>
            </div>
